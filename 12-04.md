...
```
SELECT DATE_FORMAT (payment_date, "%M %Y") SUM(p.amount) "сумма платежей", COUNT(p.rental_id) "кол-во аренд" 
from payment p
...
![image](https://github.com/Redcorprus/sdb-homeworks/blob/main/img/12-04/img4.png)
